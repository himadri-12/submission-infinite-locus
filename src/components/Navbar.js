...
import CartIcon from "../assests/Navbar/cart-shopping-solid.svg";
import Search from "../assests/Navbar/magnifying-glass-solid.svg";
    ...
    <div className="navbar">
      <div className="left-side">
        ...
        <div className="delivery-address">
          ...
          <div className="actual-address">
            721-744, RWA Marg, Arun Vihar, Sector 37, Noida, Uttar Pradesh
            201303, India
          </div>
        </div>
      ...
      <div className="right-side">
        ...
        <div className="cart-container">
          <img src={CartIcon} height={20} width={20} />
